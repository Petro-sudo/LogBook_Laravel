                ...
                <div class="card">
                   ...
                   <form method="post" action="{{route('updateprofile', ['user'=>$user])}}">
                       ...
                       <div class="card-body" style="text-align: left;">
                            ...
                            <div class="mb-3 row">
                                     <label for="surname" class="col-md-4 col-form-label text-md-start text-start">Surname</label>
                                            <div class="col-md-4">
                            ...
                            <div class="mb-3 row">
                                         <label for="perselNo" class="col-md-4 col-form-label text-md-start text-start">Persel Number</label>
                                    <div class="col-md-4">
