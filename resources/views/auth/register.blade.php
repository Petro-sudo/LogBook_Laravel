        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="perselNo" class="col-md-4 col-form-label text-md-end text-start">Persel Number</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('perselNo') is-invalid @enderror" id="perselNo" name="perselNo" value="{{ old('perselNo') }}">
